...
<template>
  <header>
    <header>
      <div class="flex w-full flex-col h-12 md:h-16 justify-center">
        <div class="transition-all text-2xl md:text-4xl font-bold text-center">Witcher: Old World Tools</div>
